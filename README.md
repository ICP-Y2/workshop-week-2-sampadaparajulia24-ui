...
We observed that when we connect four 1.5V batteries in parrel the simulator shows overall voltage of 1.5V, hence when the batteries are connected in parrel the overall voltage across, the circuit is same.
...
we observed that the light sparked brightly when the resistor resistance was kept 1 kilo ohm and led sparked less when the resistance was 6 kilo ohm but it was damaged when we kept the resistance 6 ohm . Hence we observed that when the resistance of the resistor was decresed the current increases but when the resistance was increased  the current decreased.
...
a.	R2: ___4_____________ V: ________20_____    Measured Voltage: ______16__________

b.	R2: _____3___________ V: ______25_______    Measured Voltage: ______18.7__________

c.	R2: ______7__________ V: _________7____    Measured Voltage: _____6.12___________
